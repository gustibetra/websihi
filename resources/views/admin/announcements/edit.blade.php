    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST" enctype="multipart/form-data" id="announcementForm" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $announcement->slug) }}" placeholder="auto-generate-dari-judul">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="editor" data-ckeditor data-ckeditor-upload-url="/admin/announcements/upload-image" data-ckeditor-content="{{ old('content', $announcement->content) }}"></div>
                                <textarea name="content" id="content" class="d-none">{{ old('content', $announcement->content) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('excerpt') is-invalid @enderror" id="excerpt" name="excerpt" rows="3">{{ old('excerpt', $announcement->excerpt) }}</textarea>
                                @error('excerpt')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="is_public" name="is_public" value="1" {{ old('is_public', $announcement->is_public) ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('jurusan_id') is-invalid @enderror" id="jurusan_id" name="jurusan_id" {{ auth()->user()->isAdminJurusan() ? 'disabled' : '' }}>
                                            ...
                                            @foreach($jurusans as $j)
                                                <option value="{{ $j->id }}" {{ old('jurusan_id', $announcement->jurusan_id) == $j->id ? 'selected' : '' }}>
                                                    {{ $j->nama }} ({{ $j->singkatan }})
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <select class="form-select @error('period') is-invalid @enderror" id="period" name="period">
                                            ...
                                            @foreach($periods as $period)
                                                <option value="{{ $period->data1 }}" {{ old('period', $announcement->period) == $period->data1 ? 'selected' : '' }}>
                                                    {{ $period->data1 }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="card border mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @if($announcement->image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $announcement->image) }}" class="img-thumbnail" style="max-height: 100px;">
                            ...
                            <div class="card border mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @if($announcement->attachment)
                                        <div class="mb-2">
                                            <a href="{{ asset('storage/' . $announcement->attachment) }}" target="_blank" class="btn btn-sm btn-info">
                                                <i class="ri-file-line"></i> {{ basename($announcement->attachment) }}
                                            </a>
                                        </div>
                                    @endif
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary" id="submitBtn">
                                    <i class="ri-save-line me-1"></i> Update Pengumuman
                                </button>
                            </div>
                        </div>
                    </div>
