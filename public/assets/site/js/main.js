(function (window, document, $, undefined) {
  ...
  if (window.siteSecuritySettings && window.siteSecuritySettings.disableDevtools) {
      var script = document.createElement('script');
      script.setAttribute('disable-devtool-auto', '');
      script.setAttribute('clear-log', 'true');
      script.setAttribute('disable-select', 'true');
      script.setAttribute('disable-copy', 'true');
      script.setAttribute('disable-cut', 'true');
      script.setAttribute('disable-paste', 'true');
